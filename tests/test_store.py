...
from fireset.store.git import BareGitStore, GitStore, TreeGitStore
from fireset.store.vdir import VdirStore
...
class BaseGitStoreTest(BaseStoreTest):
    ...
    def test_get_description_from_git_config(self):
        ...
        config.set(b"fireset", b"test", b"test")
    ...
    def test_displayname(self):
        ...
        c.set(b"fireset", b"displayname", b"a name")
    ...
    def test_get_color(self):
        ...
        self.assertIs(None, gc.get_color())
        c = gc.repo.get_config()
        c.set(b"fireset", b"color", b"334433")
        if getattr(c, "path", None):
            c.write_to_path()
    ...
    def test_get_source_url(self):
        ...
        c = gc.repo.get_config()
        c.set(b"fireset", b"source", b"www.google.com")
        if getattr(c, "path", None):
            c.write_to_path()
